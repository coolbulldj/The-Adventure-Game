...
class UIStructure:
    ...
    def _addChild(self, _):
        ThrowWarning(
            "Add child method was performed on a UI Structure this class doesn't allow children"
        )

    def _removeChild(self, _):
        ThrowWarning(
            "Remove child method was performed on a UI Structure this class doesn't allow children"
        )

    def renderChildren(self):
        ThrowError(
            "Render children method was performed on a UI Structure this class doesn't allow children therfore can't render children"
        )
